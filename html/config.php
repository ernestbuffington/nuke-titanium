...
/***********************************************************************************/
/* You finished configuring your Database. Now you can change all                  */
/* you want to in the Administration Section. To enter just launch                 */
/* your Firefox, Edge or Chrome browser pointing it to http://xxxxxx.xxx/admin.php */
/* (Change xxxxxx.xxx to your domain name, for example: php-nuke.coders.exchange)  */
/*                                                                                 */
/* Remember to go to your Preferences section so you can configure your            */
/* new portal/site. In that menu you can customize anything you like.              */
/*                                                                                 */
/* Congratulations! now you have an automated web portal!                          */
/* Thanks for choosing PHP-Nuke Titanium: Over 30 Years of Programming Experience  */
/***********************************************************************************/
