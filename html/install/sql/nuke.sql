...
INSERT INTO nuke_config VALUES ('PHP-Nuke Powered Site', 'http://nukeurl', 'logo.gif', 'Your slogan here', 'May 2007', 'webmaster@php-nuke.coders.exchange', 0, 'org_green', 1, '<a rel="nofollow" href="http://php-nuke.coders.exchange/" target="blank"><img alt="Web site powered by PHP-Nuke" hspace="10" src="images/powered/powered8.jpg" border="0" /></a><br />', 'All logos and trademarks in this site are property of their respective owner. The comments are property of their posters, all the rest &copy; 2005 by me.', 'You can syndicate our news using the file <a href="backend.php">backend.php</a> or <a href="ultramode.txt">ultramode.txt</a>', 4096, 'Anonymous', 5, 1, 1, 1, 1, 10, 10, 1, 30, 0, 1, 'PHP-Nuke Powered Site', 'en-us', 'english', 'en_US', 0, 0, 0, 'me@php-nuke.coders.exchange', 'NEWS for my site', 'Hey! You got a new submission for your site.', 'webmaster', 0, 1, 1, 1000, 0, 3, '*****', '<a rel="nofollow" href="http://php-nuke.coders.exchange"><font class="footmsg_l">PHP-Nuke</font></a> Copyright &copy; 2005 by Francisco Burzi. This is free software, and you may redistribute it under the <a rel="nofollow" href="http://php-nuke.coders.exchange/files/gpl.txt"><font class="footmsg_l">GPL</font></a>. PHP-Nuke comes with absolutely no warranty, for details, see the <a rel="nofollow" href="http://php-nuke.coders.exchange/files/gpl.txt"><font class="footmsg_l">license</font></a>.', '8.1', 0, 1, 0);
# --------------------------------------------------------
...
INSERT INTO nuke_headlines VALUES (22, 'PHP-Nuke', 'http://php-nuke.coders.exchange/backend.php');
