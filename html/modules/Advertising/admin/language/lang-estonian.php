...
define("_SHOW","Näita");
define("_BANNERSADMIN","Bännerid");
define("_ACTIVEBANNERS","Praegu aktiivsed bannerid");
define("_ACTIVEBANNERS2","Aktiivsed bannerid");
define("_IMPRESSIONS","Näitamist");
define("_IMPLEFT","Näitamist järel");
define("_CLICKS","Klikke");
define("_CLICKSPERCENT","% Klikke");
define("_CLIENTNAME","Kliendi nimi");
define("_ADVERTISINGCLIENTS","Reklaami kliente");
define("_CONTACTNAME","Kontakti nimi");
define("_CONTACTEMAIL","Kontakti email");
define("_ADDNEWBANNER","Lisa uus banner");
define("_PURCHASEDIMPRESSIONS","Ostetud näitamist");
define("_IMAGEURL","Pildi URL");
define("_CLICKURL","Kliki URL");
define("_ADDBANNER","Lisa banner");
define("_ADDCLIENT","Lisa uus klient");
define("_CLIENTLOGIN","Kliendi logimine");
define("_CLIENTPASSWD","Kliendi salasõna");
define("_ADDCLIENT2","Lisa klient");
define("_DELETEBANNER","Kustuta banner");
define("_SURETODELBANNER","Oled sa kindel, et soovid kustutada seda Bannerit?");
define("_EDITBANNER","Redigeeri Bannerit");
define("_ADDIMPRESSIONS","Lisa rohkem näitamisi");
define("_DELETECLIENT","Kustuta reklaamitav klient");
define("_SURETODELCLIENT","Oled sa kindel, et soovid kustutada selle Klienti ja kõiki tema Bannereid!!!");
define("_CLIENTWITHOUTBANNERS","Sellel Kliendil pole käivitatud ühtegi Bannerit.");
define("_DELCLIENTHASBANNERS","Sellel kliendil on järgnevad AKTIIVSED BANNERID käivitatud");
define("_EDITCLIENT","Redigeeri reklaamitavat klienti");
