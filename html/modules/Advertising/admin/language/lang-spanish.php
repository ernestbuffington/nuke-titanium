...
define("_CLASS","Clase");
define("_CLASSNOTE","Si tu Clase de Banner es Código Javascript/HTML los siguientes 3 campos serán ignorados y sólo se tomará en cuenta el campo de código. Si tu Clase de Banner es Flash debes especificar el URL completo del archivo .SWF en el campo que sigue (Los campos URL para el Click y Texto Alterno serán ignorados.");
define("_ADCLASS","Class de Banner");
define("_ADIMAGE","Imagen");
define("_ADCODE","Código Javascript/HTML");
define("_ADFLASH","Flash");
define("_IMAGESIZE","Tamaño de Imagen");
define("_WIDTH","Ancho");
define("_HEIGHT","Alto");
define("_INPIXELS","(tamaño en pixels)");
define("_FLASHFILEURL","URL de Archivo Flash");
define("_FLASHSIZE","Tamaño del Flash");
