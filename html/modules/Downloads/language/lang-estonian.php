...
define("_NOMATCHES","Sinu päringule ei leitud vastust");
...
define("_DOWNLOADNOW","Lae see fail nüüd alla!");
...
define("_DSUBMITONCE","Saada unikaalne fail ainul korra.");
define("_DPOSTPENDING","Kõik failid on saadetud sõltumatta kinnitusest.");
define("_RESSORTED","Failid hetkel sorteeritud");
define("_DOWNLOADSNOTUSER1","Sa ei ole registreeritud kasutaja või sa pole sisse loginud.");
define("_DOWNLOADSNOTUSER2","Kui sa oled registreeritud, siis sa võid lisada faile sellelt veebilehelt.");
define("_DOWNLOADSNOTUSER3","Registreeritud kasutajaks saamine on kiire ja lihtne protsess.");
define("_DOWNLOADSNOTUSER4","Miks me nõuame registratsiooni teatud võimalustele juurdepääsuks?");
define("_DOWNLOADSNOTUSER5","Niisiis me võime pakkuda sulle ainult kõrgema kvaliteediga sisu,");
...
define("_DOWNLOADSNOTUSER8","<a href=\"modules.php?name=Your_Account\">Registreeri Konto</a>");
...
define("_DOWNLOADRECEIVED","Me võtsime vastu sinu faili. Tänud!");
...
define("_TRATEDDOWNLOADS","kokku hinnatud faile");
...
define("_DONLYREGUSERSMODIFY","Ainult registreeritud kasutajad võivad soovitada failide modifikatsiooni. Palun <a href=\"modules.php?name=Your_Account\">registreeri või logi sisse</a>.");
...
define("_DRATENOTE4","Sa võid näha nimekirja <a href=\"modules.php?name=Downloads&amp;d_op=TopRated\">Top hinnatud failid</a>.");
define("_DATE","Kuupäev");
define("_TO","Kellele");
define("_NEW","Uued");
define("_POPULAR","Populaarsemad");
define("_TOPRATED","Hinnatumad");
define("_ADDITIONALDET","Lisainfo");
...
define("_CHECKFORIT","Sa ei andnud Emaili addressi, aga me kontrollime sinu linki varsti.");
...
define("_ALLOWTORATE","Lase teistel kasutajatel hinnata seda oma veebilehelt!");
...
define("_WEIGHNOTE","* NB: Sellel failil kaalub Registreeritud ja Registreerimata kasutajate hinnang");
define("_NOUNREGUSERSVOTES","Registreerimata kasutaja hääli ei ole");
define("_WEIGHOUTNOTE","* NB: Sellel failil kaal registreeritud ja väliste hääletajate hinnang");
...
define("_PROMOTE01","Võibolla oled Sa huvitatud mitme kaug 'Hinda veebilehte' valikust, mis on meil saadaval. Need lasevad sul asetada pildi (või isegi hindamise vormi) sinu webi lehele, tellides juurdekasvu numbrites hääli oma faili saamisel. Palun vali üks valikutest alljärgnevast nimekirjast:");
define("_TEXTLINK","Teksti link");
...
define("_HTMLCODE2","Lähtekood nupust allpool on:");
...
define("_PROMOTE05","Tänud! ja edu sinu hindamistel!");
define("_STAFF","");
define("_THANKSBROKEN","Tänan sind abi eest, et aitad ülal hoida kataloogi terviklikkust.");
define("_SECURITYBROKEN","Turavlisuse põhjusel Sinu kasutajanimi ja IP address on ajutiselt salvestatud.");
define("_THANKSFORINFO","Tänan informatsiooni eest.");
define("_LOOKTOREQUEST","Me vaatame Sinu taotlust peagi.");
define("_SENDREQUEST","Saada Taotlus");
define("_THANKSTOTAKETIME","Tänan Sind, et leidsid aega hinnata seda lehte siin");
...
define("_COMPLETEVOTE3","Hinda faili ainul korra.<br>Kõik hinnangud on logitud ja arvutatud.");
