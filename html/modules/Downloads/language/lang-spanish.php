...
define("_POPULARITY1","Popularidad (de menos a más impresiones)");
define("_POPULARITY2","Popularidad (de más a menos impresiones)");
...
define("_ISTHISYOURSITE","¿Es éste tu recurso?");
...
define("_NUMRATINGS","Número de valoraciones");
...
define("_RATENOTE3","Trata de ser objetivo en tu voto, si se recibe siempre 1 ó 10, la valoración no será útil.");
...
define("_DSUBMITONCE","Enviar un Download sólo una vez.");
