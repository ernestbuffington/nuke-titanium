...
define("_ADDDOWNLOAD","Leg til nedlastning");
define("_DOWNLOADSMAIN","Nedlastningsindex");
...
define("_DOWNLOADSNOTUSER2","Når du registrerer deg kan du legge til filer for nedlastning på dette webstedet.");
...
define("_DRATENOTE4","Du kan se en liste over nedlastningene med høyest poengsum <a href=\"modules.php?name=Downloads&amp;d_op=TopRated\">her</a>.");
define("_DATE","Dato");
define("_TO","Til");
define("_NEW","Ny");
...
define("_RATETHISSITE","Poengsett dette webstedet");
define("_ISTHISYOURSITE","Er dette ditt websted?");
define("_ALLOWTORATE","La andre på stemme fra ditt eget websted!");
define("_OVERALLRATING","Gjennomstnittlig poengsum");
define("_TOTALOF","Totalt");
define("_USER","Medlemmer");
define("_USERAVGRATING","Medlemmers gjennomsnittssum");
...
define("_WEIGHNOTE","* Obs: Dette webstedet veier medlemmers poengsum opp mot ikke-medlemmers");
define("_NOUNREGUSERSVOTES","Ingen ikke-medlemmer har stemt");
define("_WEIGHOUTNOTE","* Obs: Dette webstedet veier medlemmers poengsum opp mot poengsummer fra andre websteder");
define("_NOOUTSIDEVOTES","Ingen poengsummer fra andre websteder");
define("_OUTSIDEVOTERS","Poengsummer fra andre websteder");
define("_UNREGISTEREDUSERS","Ikke-registrerte medlemmer");
define("_PROMOTEYOURSITE","Markedsfør ditt websted");
define("_PROMOTE01","Du er kanskje interessert i de ulike 'Poengsettingsmodellene' vi kan tilby. Disse gjør at du kan legge et bilde eller et skjema på din egen webside slik at dine brukere kan stemme på deg direkte. Velg en av mulighetene under:");
...
define("_IDREFER","i HTML koden refererer til ditt websteds IDnummer i $sitename database. Påse at dette nummeret er med.");
...
define("_THANKSTOTAKETIME","Takk for at du stemte på et websted her på");
...
define("_IFYOUWEREREG","Når du blir medlem kan du kommentere dette webstedet.");
