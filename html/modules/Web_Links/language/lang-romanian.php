...
define("_NOMATCHES","Nu au fost gasiti termeni potriviti cererii Dvs.");
define("_SCOMMENTS","Comentarii");
define("_DESCRIPTION","Descriere");
define("_DATE","Data");
define("_TO","Catre");
define("_ADDLINK","Adauga link");
define("_NEW","Nou");
define("_POPULAR","Popular");
define("_TOPRATED","Cele mai populare");
define("_RANDOM","aleator");
define("_LINKSMAIN","Pagina principala de linkuri");
define("_LINKCOMMENTS","Comentarii link");
define("_ADDITIONALDET","Detalii suplimentare");
define("_EDITORREVIEW","Recenzia editorului");
define("_REPORTBROKEN","Anunta un link nefunctional");
define("_LINKSMAINCAT","Categorii principale de linkuri");
define("_AND","si");
define("_INDB","in baza noastra de date");
define("_ADDALINK","Adauga link");
define("_INSTRUCTIONS","Instructiuni");
define("_SUBMITONCE","Trimite  un link doar o singura data.");
define("_POSTPENDING","Toate linkurile sunt verificate inainte de postare");
define("_USERANDIP","Numele de utilizator si IP-ul sunt inregistrate, asa ca va rugam nu abuzati de sistem.");
define("_PAGETITLE","Titlul paginii");
define("_PAGEURL","Page URL");
define("_YOUREMAIL","Email-ul Dvs.");
define("_LDESCRIPTION","Descriere: (255 caractere max)");
define("_ADDURL","Adauga acest URL");
define("_LINKSNOTUSER1","Nu sunteti utilizator inregistrat sau nu v-ati logat.");
define("_LINKSNOTUSER2","Daca sunteti inregistrat puteti adauga linkuri in acest website.");
define("_LINKSNOTUSER3","A deveni utilizator inregistrat este un proces usor si rapid.");
define("_LINKSNOTUSER4","De ce este necesara inregistrarea pentru accesul la anumite facilitati?");
define("_LINKSNOTUSER5","Doar asa va putem oferi continut de cea mai buna calitate,");
define("_LINKSNOTUSER6","fiecare item este verificat individual si aprobat de catre personalul nostru.");
define("_LINKSNOTUSER7","Speram sa va oferim doar informatii de valoare.");
define("_LINKSNOTUSER8","<a href=\"modules.php?name=Your_Account\">Inregistrati-va pentru a va crea un cont</a>");
define("_LINKALREADYEXT","EROARE: Acest URL este deja listat in baza de date!");
define("_LINKNOTITLE","EROARE: Trebuie sa scrieti un TITLU pentru URL-ul dvs.!");
define("_LINKNOURL","EROARE: Trebuie sa scrieti un URL !");
define("_LINKNODESC","EROARE: Trebuie sa scrieti o DESCRIERE pentru URL-ul dvs.");
define("_LINKRECEIVED","Am primit linkul trimis de Dvs. Multumim!");
define("_EMAILWHENADD","Veti primi un E-mail cand va fi aprobat.");
define("_CHECKFORIT","Nu ati furnizat o adresa de email dar vom verifica linkul dvs. curand.");
define("_NEWLINKS","Linkuri noi");
define("_TOTALNEWLINKS","Total Linkuri noi");
define("_LASTWEEK","Saptamana trecuta");
define("_LAST30DAYS","Ultimele 30 zile");
define("_1WEEK","1 Saptamana");
define("_2WEEKS","2 Saptamani");
define("_30DAYS","30 zile");
define("_SHOW","Arata");
define("_TOTALFORLAST","Total linkuri noi in ultimele");
define("_DAYS","zile");
define("_ADDEDON","Adaugate la");
define("_RATING","Apreciere");
define("_RATESITE","Apreciaza this Site");
