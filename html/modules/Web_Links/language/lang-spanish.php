...
define("_LETSDECIDE","Tu información permitirá a otros visitantes decidir mejor sobre qué enlaces escoger.");
...
define("_PROMOTE01","Tal vez te interesa unas de la opciones que tenemos para la 'Valoración de otros sitios'. Estas te permiten poner una imagen (o un formulario de votación) en tu sitio Web para incrementar sus votos. Por favor elige una de estas opciones:");
...
define("_COMPLETEVOTE2","Tú ya has votado por este recurso en los pasados $outsidewaitdays día(s).");
