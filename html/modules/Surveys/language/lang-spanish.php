...
define("_ATTACHEDTOARTICLE","- Anexa al artículo:");
define("_SURVEYSATTACHED","Encuestas Anexas a Noticias");
define("_LAST5POLLS", "Ultimas 5 Encuestas en");
define("_MOREPOLLS", "...más encuestas");
define("_COMMENTSMODERATION","Sistema de Moderación de Comentarios");
define("_MODERATE","Moderar");
define("_CLICKTOMODERATE","Por favor selecciona los valores de moderación para cada comentario de esta encuesta, luego haz click en el botón <i>Moderar</i> ubicado abajo para guardar tus preferencias de moderación. Sé justo en cada valoración, ésto contribuirá y beneficiará a todos los lectores. Gracias.");
